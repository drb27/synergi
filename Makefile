...
CXXFLAGS_EXTRA=
LIBS=-lasound
SYNERGI_OBJS=src/eng/source.o src/eng/outlet.o src/eng/transform.o src/eng/sink.o src/eng/dsp.o src/main.o src/osc/wavetable.o src/osc/oscillator.o src/osc/puresine.o src/buf/circularbuffer.o src/osc/silence.o
